          ...
          <div className="grid grid-cols-1 gap-3 text-[13px] leading-snug text-zinc-800 sm:grid-cols-2">
            ...
            <Section title="Game Setup" accent>
              <ol className="ml-4 list-decimal space-y-0.5">
                ...
                <li><B>Mix:</B> all 152 tiles face-down, everyone mixes them around</li>
                <li><B>Build walls:</B> each player makes a wall 19 tiles long, 2 tiles high</li>
                <li><B>Roll &amp; break:</B> East rolls dice, counts that many from the right along the wall, keeps counted tiles and pushes the rest out</li>
                <li><B>Deal:</B> each player takes 4 tiles (2 top + 2 bottom) starting with East, going right. 3 rounds, then East takes the 1st and 3rd top tiles, others take 1 each</li>
              </ol>
